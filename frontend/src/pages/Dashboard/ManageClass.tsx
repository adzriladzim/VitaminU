// File: src/pages/Dashboard/ManageClass.tsx

import { useState } from "react";
import { useClassData } from "../../context/ClassDataContext";
// HAPUS: import { userBookings } from "../../data/userBookings"; // Dihapus karena kita pakai userLogs
import {
    Table,
    TableBody,
    TableCell,
...
export default function ManageClass() {
    ...
    const handleEditClick = (cls: any) => { setEditingId(cls.id); setCurrentStatus(cls.status); };
    const handleCancel = () => { setEditingId(null); };

    // 💡 FUNGSI ADMIN: handleSave (logging)
    const handleSave = (id: number) => {
        updateClassManually(id, currentStatus);
        setEditingId(null);
    };
                    ...
                    >
                        ...
                        {editingId === cls.id ? (
                            ...
                            <div>
                                ...
                                <div className="space-x-2">
                                    {/* Tombol Approve disarankan muncul hanya jika status adalah 'Booked' */}
                                    {cls.status === "Booked" && (
                                        <button
            ...
            <div className="mt-8">
                ...
                <div className="border border-gray-200 rounded-lg overflow-hidden">
                    <Table>
                        ...
                        <TableBody>
                            {userLogs.map((booking) => ( // 💡 Menggunakan userLogs
