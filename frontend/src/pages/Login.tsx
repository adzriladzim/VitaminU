...
export default function Login() {
  ...
  // Handle perubahan input (Kode sudah benar)
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    if (validate()) {
      console.log("Login Data Valid:", form);
  ...
  return (
    ...
    >
      ...
      <div className="bg-white/90 shadow-lg rounded-md p-8 w-full max-w-md relative z-40">
        ...
        <p className="text-center">Login to book the room</p>
...
              `}
          ...
          <Button
            type="button"
            // Menggunakan styling outline/secondary untuk tombol pihak ketiga
